...
Ïðè âîçíèêíîâåíèè ïðîáëåì îáðàùàéòåñü â ÂÊ:
		vk.com/tvoybywshiy
...
chgName.rank = {u8"Èíòåðí", u8"Ôåëüäøåð", u8"Ïîìîùíèê Âðà÷à", u8"Äåæóðíûé Âðà÷", u8"Ïàðàìåäèê", u8"Ñïåöèàëèñò", u8"Õèðóðã", u8"Çàâåä. îòäåëåíèåì", u8"Çàì.Ãë.Âðà÷à", u8"Ãëàâ.Âðà÷", u8"Ìèíèñòð Çäðàâîîõðàíåíèÿ"}
...
local list_rank	= {u8"Èíòåðí", u8"Ôåëüäøåð", u8"Ïîìîùíèê Âðà÷à", u8"Äåæóðíûé Âðà÷", u8"Ïàðàìåäèê", u8"Ñïåöèàëèñò", u8"Õèðóðã", u8"Çàâåä. îòäåëåíèåì", u8"Çàì.Ãë.Âðà÷à", u8"Ãëàâ.Âðà÷", u8"Ìèíèñòð Çäðàâîîõðàíåíèÿ"}
--chat
...
[2]=Íîâàÿ ìåä.êàðòà(Äî 4-ãî ëâë áåñëïëàòíî íà 7äí.)
Õîðîøî, ÿ Âàñ {sex:ïîíÿë|ïîíÿëà}. Âàì íóæíî îôîðìèòü íîâóþ ìåä.êàðòó.
Òàê êàê Âû íàõîäèòåñü â øòàòå ìåíåå 4 ëåò, ó íàñ åñòü âûãîäíûå óñëîâèÿ!
Äëÿ Âàñ îôîðìëåíèå êàðòû áóäåò áåñïëàòíûì, íî òîëüêî íà ñåìü äíåé.
Íî íà äðóãîå êîëè÷åñòâî äíåé áóäåò ïëàòíûì.
Âû ñîãëàñíû?
Åñëè ñîãëàñíû, òî ìû ïðîäîëæèì ïðîöåäóðó îôîðìëåíèÿ ìåä êàðòû.
{dialog}
[name]=Ñðîê âûäà÷è
[1]=7 äíåé(ÁÅÑÏËÀÒÍÎ! ÄÎ 4 ëâë)
#timeID=0
[2]=14 äíåé
#timeID=1
[3]=30 äíåé
		...
		imgui.Begin(fa.ICON_HEARTBEAT .. " MedicalHelper (Mesa) "..scr.version, mainWin, imgui.WindowFlags.NoResize);
			...
			if select_menu[7] then
				...
				imgui.BeginChild("about", imgui.ImVec2(0, 0), true)
					...
					imgui.Bullet()
					imgui.TextColoredRGB("Ðàçðàáîò÷èê - {FFB700}Kevin Hatiko {ffffff}| Ðåäàêòîð Ñêðèïòà - {FFB700}Kyle Morgan")
					imgui.Bullet()
					...
					imgui.TextColoredRGB("Áëàãîäàðíîñòü blast.hk çà ìåòîäè÷åñêóþ èíôîðìàöèþ è åãî ïîëüçîâàòåëÿì â ðåøåíèè âîïðîñîâ.")
						...
						imgui.SameLine()
						imgui.TextColoredRGB("Äëÿ ñâÿçè: VK: {74BAF4}vk.com/tvoybywshiy") --èëè Discord - {74BAF4}Humans#0110")
						...
						imgui.SameLine()
						imgui.TextColoredRGB("Ñêðèïò ðàáîòàåò íà ÁÅÑÏËÀÒÍÎÉ îñíîâå! Âñå ñäåëàíî äëÿ ÌÇ!")
...
function funCMD.rec(id)
	if thread:status() ~= "dead" then 
		...
		sampAddChatMessage("{FFFFFF}[{EE4848}MedicalHelper{FFFFFF}]: Èñïîëüçóéòå êîìàíäó /rc [id èãðîêà].", 0xEE4848)
		end
end
