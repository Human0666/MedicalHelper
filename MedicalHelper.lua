...
script_description("Script for the Ministries of Health Arizona Mesa")
...
chgName.rank = {u8"Интерн", u8"Фельдшер", u8"Помощник Врача", u8"Дежурный Врач", u8"Парамедик", u8"Специалист", u8"Хирург", u8"Завед. отделением", u8"Зам.Гл.Врача", u8"Глав.Врач", u8"Министр Здравоохранения"}
...
local list_rank	= {u8"Интерн", u8"Фельдшер", u8"Помощник Врача", u8"Дежурный Врач", u8"Парамедик", u8"Специалист", u8"Хирург", u8"Завед. отделением", u8"Зам.Гл.Врача", u8"Глав.Врач", u8"Министр Здравоохранения"}
--chat
...
[2]=Новая мед.карта(До 4-го лвл беслплатно на 7дн.)
Хорошо, я Вас {sex:понял|поняла}. Вам нужно оформить новую мед.карту.
Так как Вы находитесь в штате менее 4 лет, у нас есть выгодные условия!
Для Вас оформление карты будет бесплатным, но только на семь дней.
Но на другое количество дней будет платным.
Вы согласны?
Если согласны, то мы продолжим процедуру оформления мед карты.
{dialog}
[name]=Срок выдачи
[1]=7 дней(БЕСПЛАТНО! ДО 4 лвл)
#timeID=0
[2]=14 дней
#timeID=1
[3]=30 дней
...
/medcard #playerID #healID #timeID 1000]]  
	...
	lockPlayerControl(false)
		...
		sampRegisterChatCommand("rc", funCMD.rec)
...
function imgui.OnDrawFrame()
	if mainWin.v then
		...
		imgui.Begin(fa.ICON_HEARTBEAT .. " MedicalHelper (Mesa) "..scr.version, mainWin, imgui.WindowFlags.NoResize);
			...
			imgui.BeginChild("Mine menu", imgui.ImVec2(155, 0), true)
				...
				imgui.Separator()
					imgui.Spacing()
				if ButtonMenu(fa.ICON_HEADPHONES .. u8"  F.A.Q", select_menu[8]) then select_menu = {false, false, false, false, false, false, false, true, false} end
				imgui.Separator()
					imgui.Spacing()
			...
			if select_menu[7] then
				...
				imgui.BeginChild("about", imgui.ImVec2(0, 0), true)
					...
					imgui.TextColoredRGB("Благодарность blast.hk за методическую информацию и его пользователям в решении вопросов.")
						...
						imgui.SameLine()
						imgui.TextColoredRGB("Для связи: VK: {74BAF4}vk.com/tvoybywshiy") --или Discord - {74BAF4}TheVitek#2160")
						...
						imgui.SameLine()
						imgui.TextColoredRGB("Скрипт работает на БЕСПЛАТНОЙ основе! Все для МЗ!")
			...
			if select_menu[8] then
				imgui.SameLine()
				imgui.BeginChild("FAQ", imgui.ImVec2(0,0), true)
					--
					imgui.Bullet(); imgui.SameLine()
					imgui.TextColoredRGB("{FFB700}Единая Система повышения")
					imgui.Separator()
					imgui.SetCursorPosX(200)
					imgui.TextColoredRGB("{1ABC9C}Интерн{ffffff} (1 ранг) —> {1ABC9C}Фельдшер{ffffff} (2 ранг)")
					imgui.TextColoredRGB("{EE82EE}1.{ffffff} Сдать речь на лечение пациентов (/hl)\n{EE82EE}2.{ffffff} Сдать знание устава министерства здравоохранения")
					imgui.Separator()
					imgui.SetCursorPosX(170)
					imgui.TextColoredRGB("{54ACD2}Фельдшер{ffffff} (2 ранг) —> {54ACD2}Помощник Врача{ffffff} (3 ранг)")
					imgui.TextColoredRGB("{EE82EE}1.{ffffff} Вылечить 35-45 пациентов (/hl)\n{EE82EE}2.{ffffff} Сдать речь на выдачу мед.карты\n{EE82EE}3.{ffffff} Сдать правила /expel")
					imgui.Separator()
					imgui.SetCursorPosX(170)
					imgui.TextColoredRGB("{FAC51C}Помощник Врача{ffffff} (3 ранг) —> {FAC51C}Парамедик{ffffff} (5 ранг)")
					imgui.TextColoredRGB("{EE82EE}1.{ffffff} Сдать речь на выдачу рецептов / лечение наркозависимости [При повышении на 4 ранг]\n{EE82EE}2.{ffffff} Сдать речь на выдачу антибиотиков / вакцинацию от Covid-19 / реанимацию пострадавших на..\n ..вызове [При повышении на 5 ранг]\n{EE82EE}3.{ffffff} Вылечить 45 - 55 пациентов\n{EE82EE}4.{ffffff} Активно принимать участие в жизни больницы (помогать рук.составу)\n{EE82EE}5.{ffffff} Выполнять квест “Выдаем мед.карты”\n{EE82EE}6.{ffffff} Выполнять поручения от старшего состава\n{EE82EE}7.{ffffff} Выполнять поручения от руководящего состава\n{EE82EE}8.{ffffff} Пройти переаттестацию у Главного врача или Заместителя [При повышении на 5 ранг]\n{EE82EE}9.{ffffff} Присутствовать на мед.проверках / вакцинациях других гос.структур")
					imgui.Separator()
					imgui.SetCursorPosX(150)
					imgui.TextColoredRGB("{00FF7F}Парамедик{ffffff} (5 ранг) —> {00FF7F}Заведующий отделением{ffffff} (8 ранг)")
					imgui.TextColoredRGB("{EE82EE}1.{ffffff} Пройти переаттестацию у Главного врача или Заместителя в спец.рации Discord ..\n..[При повышении на 8 ранг]\n{EE82EE}2.{ffffff} Вылечить 55 - 105 пациентов\n{EE82EE}3.{ffffff} Принимать активное участие в жизни больницы (Помощь Главному врачу и его Заместителю)\n{EE82EE}4.{ffffff} Выполнять квест “Выдаем мед карты”\n{EE82EE}5.{ffffff} Проводить / помогать в проведении операций\n{EE82EE}6.{ffffff} Активно работать с сотрудниками младшего состава (учить чему либо / помогать..\n..или проводить различные РП)\n{EE82EE}7.{ffffff} Выполнять квест “Нужны медикаменты”\n{EE82EE}8.{ffffff} Выполнять поручения от Руководящего состава больницы\n{EE82EE}9.{ffffff} Проводить вакцинации / мед.проверки гос.структур своего города [Исключения : СТК, ГЦЛ, ..\n..ЦБ, ФБР, Пра-во]\n{EE82EE}10.{ffffff} Активно принимать вызовы от граждан с RP отыгровками [/gomedic | /cure] или вызовы от..\n..SAMC\n{EE82EE}11.{ffffff} Иметь RP биографию своего персонажа [При повышении на 8 ранг]")
					imgui.Separator()
					imgui.SetCursorPosX(90)
					imgui.TextColoredRGB("{FF00FF}Заведующий отделением{ffffff} (8 ранг) —> {FF00FF}Заместитель Главного Врача{ffffff} (9 ранг)")
					imgui.TextColoredRGB("{EE82EE}1.{ffffff} Принимать активное участие в жизни больницы\n{EE82EE}2.{ffffff} Помогать в проведении собеседований\n{EE82EE}3.{ffffff} Обязательно сделать 2 скриншот ситуации и 5 РП с личным составом\n{EE82EE}4.{ffffff} Выполнять различные квесты больницы НПС бота\n{FF6347}Примечания: {ffffff}Главный врач повышает на данную должность по своему доверию и по вашей\nактивности.\nУчтите то что любая работа идет вам только в плюс также любой вклад в больницу будет учтен.")
					imgui.Separator()
					--
				imgui.EndChild()
			end
...
function funCMD.rec(id)
	if thread:status() ~= "dead" then 
		...
		sampAddChatMessage("{FFFFFF}[{EE4848}MedicalHelper{FFFFFF}]: Используйте команду /rc [id игрока].", 0xEE4848)
		end
end
...
function funCMD.update()
	...
	local url = "https://github.com/Human0666/MedicalHelper/blob/main/MedicalHelper.lua?raw=true"
	--local url = "https://drive.google.com/uc?export=download&id=1TIy_R7R9ce9nOOJ0EQy5p8WIVsLnhq0g"
	...
	downloadUrlToFile(url, dir, function(id, status, p1, p2)
		if status == dlstatus.STATUSEX_ENDDOWNLOAD then
			if updates == nil then 
				...
				setClipboardText("https://github.com/Human0666/MedicalHelper/blob/main/MedicalHelper.lua?raw=true")
				updWin.v = false
			end
		end
		if status == dlstatus.STATUS_ENDDOWNLOADDATA then
...
function funCMD.updateCheck()
	sampAddChatMessage("{FFFFFF}[{EE4848}MedicalHelper{FFFFFF}]: Проверяем наличие обновлений...", 0xEE4848)
		...
		local url = "https://raw.githubusercontent.com/Human0666/MedicalHelper/main/MedicalHelper/files/update.med"
		downloadUrlToFile(url, dir, function(id, status, p1, p2)
			if status == dlstatus.STATUS_ENDDOWNLOADDATA then
				lua_thread.create(function()
				wait(1000)
		...
		local url = "https://raw.githubusercontent.com/Human0666/MedicalHelper/main/MedicalHelper/files/update.txt"
		downloadUrlToFile(url, dir, function(id, status, p1, p2)
			if status == dlstatus.STATUS_ENDDOWNLOADDATA then
				lua_thread.create(function()
					wait(1000)
